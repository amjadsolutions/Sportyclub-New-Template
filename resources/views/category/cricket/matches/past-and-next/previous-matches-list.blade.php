...
@section('page-styles')
    <!-- begin::meta -->
    <title>Previous Cricket Match | Finished Cricket Match | Cricket Update | Cricket News | Sportyclub Live</title>
    <meta name="title"
        content="Previous Cricket Match | Finished Cricket Match | Cricket Update | Cricket News | Sportyclub Live">
    ...
    <!-- begin::item prop -->
    <meta itemprop="name"
        content="Previous Cricket Match | Finished Cricket Match | Cricket Update | Sportyclub Live">
