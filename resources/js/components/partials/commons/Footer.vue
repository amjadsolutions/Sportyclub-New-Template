    ...
    <div class="row row-cols-1 row-cols-lg-3">
        ...
        <div class="col">
            <div class="comon-footer">
                ...
                <p class="col-lg-10">
                    SportyClub is a reliable online streaming service that
                    broadcasts live cricket on TV worldwide from over all major
                    leagues and tournaments. Our platform allows users to watch
                    live sports from anywhere, anytime, and on many electronic
                    devices.
                </p>
        ...
        <div class="col">
            <div class="comon-footer">
                ...
                <ul class="list-unstyled">
                    ...
                    <li>
                        <a href="/cricket/previous/matches">
                            Previous Matches
                        </a>
                    </li>
                    <li>
                        <a href="/cricket/upcoming/matches">
                            Upcoming Matches
                        </a>
                    </li>
                    <li>
                ...
                <ul class="list-unstyled">
                    ...
                    >
                        <li
                            v-if="index < 5"
                            v-on:click="
                                getTopLeagueDetails(league.id, league.slug)
                            "
