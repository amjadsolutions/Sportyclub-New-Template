    ...
    <div class="mn-next-part">
      <div class="container">
        ...
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
          <template v-for="(inning, index) in matchInnings" :key="inning.id">
        ...
        <div class="tab-content" id="pills-tabContent">
          ...
          <template v-for="(inning, index) in matchInnings" :key="inning.id">
            ...
            >
              <div>
                <h2 class="comon-heading m-0" v-if="inning.number == index">
                  {{ matchDetails.event.homeTeam.shortName }}
                  VS
                  {{ matchDetails.event.awayTeam.shortName }}
                </h2>
                <div class="row g-lg-5" v-if="inning.number == index">
                  <!-- begin::batting -->
                  <div class="col-lg-6">
                              ...
                              <tbody>
                                ...
                                >
                                  ...
                                  >
                                    {{ batting.playerName }}
                                    <br />
                                    <small v-if="batting.wicketTypeId == 1">
                                      B
                                      {{ batting.wicketBowler.shortName }}
                                    </small>
                                    <small
                                      v-else-if="batting.wicketTypeId == 2"
                                    >
                                      LBW
                                      {{ batting.wicketBowlerName }}
                                    </small>
                                    <small
                                      v-else-if="batting.wicketTypeId == 3"
                                    >
                                      C
                                    ...
                                    <small
                                      v-else-if="batting.wicketTypeId == 6"
                                    >
                                      C & B
                                      {{ batting.wicketBowler.shortName }}
                                    </small>
                                    <small
                                      v-else-if="batting.wicketTypeId == 10"
                                    >
                                      Not Out
                                    </small>
                                    <small
                                      v-else-if="batting.wicketTypeId == 9"
                                    >
                                    </small>
                                  </td>
                                  <td>
                                      ...
                                      <figure
                                        ...
                                        v-on:click="
                                          getTeamDetails(
                                            ...
                                            matchDetails.event.homeTeam.slug
                                          )
                                        "
                                      >
                                        <img
                                    ...
                                    <div class="comon-ft-cl">
                                        ...
                                        v-on:click="
                                          getTeamDetails(
                                            ...
                                            matchDetails.event.awayTeam.slug
                                          )
                                        "
                                      >
                                        <img
