                  ...
                  >
                    ...
                    >
                      <div>
                        ...
                        >
                          {{ matchDetails.event.homeTeam.shortName }} VS
                        ...
                        <div class="row g-lg-5" v-if="inning.number == index">
                          ...
                          <div class="col-lg-6">
                            <div class="table-div-left mt-4">
                              <h4>{{ inning.battingTeam.shortName }} Batting</h4>
                              <div
                                id="seri1_wrapper"
                                      ...
                                      <tbody>
                                        ...
                                        >
                                          <td
                                            ...
                                            "
                                          >
                                            {{ batting.playerName }} <br />
                                            <small
                                              v-if="batting.wicketTypeId == 1"
                                            >
                                              B
                                              {{
                                            ...
                                            <small
                                              v-else-if="
                                                batting.wicketTypeId == 2
                                              "
                                            >
                                              LBW {{ batting.wicketBowlerName }}
                                            </small>
                                            <small
                                              v-else-if="
                                                batting.wicketTypeId == 3
                                              "
                                            >
                                              C {{ batting.wicketCatchName }} &
                                              B
                                              {{
                                                batting.wicketBowler.shortName
                                              }}
                          ...
                          <div class="col-lg-5">
                            <div class="table-div-left mt-4">
                              <h4>{{ inning.bowlingTeam.shortName }} Bowling</h4>
                              <div
                                id="seri1_wrapper"
                                class="dataTables_wrapper"
                              >
                                    ...
                                    >
                                      ...
                                      <tbody>
                                        ...
                                        >
                                          ...
                                          <td>{{ bowling.over }}</td>
                                          <td>{{ bowling.maiden }}</td>
                                          <td>{{ bowling.run }}</td>
                                          <td>{{ bowling.wicket }}</td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </div>
