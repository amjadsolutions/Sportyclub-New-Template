<template>
  ...
  <div class="result-div1 mt-5" style="margin-top: 0px !important">
    <div class="container">
      ...
      <!-- end::loader secton -->
      <div class="row gx-lg-5 desktop-version">
        <br />
        <div class="col-lg-12 col-xl-12" v-if="!loading">
          ...
          <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="cricket/today/live/match/list" class="btn all-cm-btn">
              Live Matches
              <svg
                ...
                <div class="col-lg-12">
                  ...
                  >
                    ...
                    <div class="matches-div-home">
                      <h5>
                        <span class="d-block">
                          <small v-if="liveMatches.includes(match.status.code)">
                            <span
                              style="
                                color: white;
                                overflow: hidden;
                          ...
                          <small style="color: white" v-else>
                          ...
                          <figcaption style="width: 130% !important">
                            ...
                            <small style="font-size: 13px !important">
                              {{
                                ...
                                match.homeScore.innings.inning1
                                  ? match.homeScore.innings.inning1.score +
                                    "/" +
                          ...
                          <figcaption style="width: 130% !important">
                            ...
                            <small style="font-size: 13px !important">
                              {{
                                ...
                                match.awayScore.innings.inning1
                                  ? match.awayScore.innings.inning1.score +
                                    "/" +
  ...
  <section class="body-part-total float-start w-100" v-if="!loading">
    <div class="playerrs-div-total py-5" style="padding-top: 0px !important">
                        ...
                        >
                          ...
                          <tbody>
                            ...
                            >
                              ...
                              >
                                <td class="sorting_1">
                                  {{ getMatchDate(match.startTimestamp) }}
                                </td>
                                <td>
                                  <a class="btn ms-ti">
                                    {{ match.homeTeam.shortName }}
