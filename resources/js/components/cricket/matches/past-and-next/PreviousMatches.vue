      ...
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2
            ...
            "
          >
            {{ loading ? "Loading..." : "Previous Matches" }}
            <img
              v-if="loading"
              src="/img/spinner.gif"
              alt="Image not Found"
        ...
        <div class="table-div-left mt-4">
          <div id="seri3_wrapper" class="dataTables_wrapper">
            ...
            <div class="dataTables_length" id="seri3_length">
              ...
              >
                <a
                  v-on:click="getPreviousMatchList(val)"
              ...
              >
                ...
                <tbody>
                  ...
                  >
                    ...
                    <template v-if="finishMatches.includes(match.status.code)">
                      <td class="sorting_1">
...
export default defineComponent({
  ...
  methods: {
    ...
    getMatchDetails(matchId, homeSlug, awaySlug) {
      ...
      window.open(
        "/cricket/today/previous/match/" + team + "/" + matchId,
        "_blank"
      );
    },
  },
