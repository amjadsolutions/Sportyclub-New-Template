                    ...
                    >
                      ...
                      <li class="nav-item" role="presentation" v-on:click="changeServer('//stream.crichd.vip/update/sspsl.php')">
                        <button
                          ...
                          role="tab"
                        >
                          <i class="fas fa-calendar-alt"></i> Server 3
                        </button>
                      </li>
                      ...
                      <li class="nav-item" role="presentation" v-on:click="changeServer('//stream.crichd.vip/update/ssgrandstand.php')">
                        <button
                          ...
                          role="tab"
                        >
                          <i class="fas fa-calendar-alt"></i> Server 4
                        </button>
                      </li>
                    </ul>
                  </span>
                                  ...
                                  >
                                    ...
                                    <figcaption>
                                      ...
                                      <small
                                        ...
                                        :key="batter.id"
                                      >
                                        <small v-if="batter.wicketTypeId == 10">
                                          {{ batter.player.name }}</small
                                        ><br />
                                      </small>
                                    </figcaption>
                                  </figure>
                                    ...
                                    <span
                                      v-if="
                                        liveMatches.includes(
                                          matchDetails.event.status.code
                                        )
                                      "
                                    >
                                      <img
