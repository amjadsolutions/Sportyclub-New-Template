                        ...
                        <div class="col-lg-4">
                            <figure>
                                <img
                                    ...
                                    @error="
                                        $event.target.src =
                                            '/img/default/player-default.png'
                                    "
                                    alt="gps1"
                                />
                            </figure>
                            ...
                            <div class="players-details-div">
                                <h2 class="comon-heading m-0">
                                    ...
                                    <span class="d-block mt-2">
                                        <span v-if="player.position == 'BM'">
                                            Batsman
                                        </span>
                                        <span
                                            v-else-if="player.position == 'AR'"
                                        >
                                            All Rounder
                                        </span>
                                        <span
                                            v-else-if="player.position == 'B'"
                                        >
                                            Bowler
                                        </span>
                                        <span
                                            v-else-if="player.position == 'WK'"
                                        >
                                            Wicket Keeper
                                        </span>
                                    </span>
                ...
                .then((response) => {
                    ...
                    setTimeout(() => {
                        ...
                        for (var i = 0; i < paragraphs.length; i++) {
                            ...
                            for (
                                var j = 0;
                                j < linksInsideParagraph.length;
                                j++
                            ) {
                                // Access or manipulate each <a> element
                                linksInsideParagraph[j].href = "";
                                linksInsideParagraph[j].style.color = "black";
                                linksInsideParagraph[j].style.textDecoration =
                                    "none";
                                linksInsideParagraph[j].style.fontWeight =
                                    "bold";
                            }
                        }
                    }, 1000);
