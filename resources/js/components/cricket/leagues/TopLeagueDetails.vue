                  ...
                  <div class="col-lg-6" v-if="!loading">
                    <div class="players-details-div">
                      <h2
                        ...
                        "
                      >
                        {{ topLeagueInfo.uniqueTournament.name }}
                        <span class="d-block mt-2">
                          {{ topLeagueInfo.uniqueTournament.category.name }}
                        </span>
                      </h2>

                      <ul class="list-unstyled mt-2">
                        <li>
                          <span> Depending Champion :</span>
                          <span>
                            {{
                              topLeagueInfo.uniqueTournament.titleHolder &&
                              topLeagueInfo.uniqueTournament.titleHolder.name
                                ? topLeagueInfo.uniqueTournament.titleHolder
                                    .name
                                : " --"
                            }}
                        ...
                        <li>
                          <span> Most Titles No's :</span>
                          <span>
                            {{
                              topLeagueInfo.uniqueTournament.titleHolderTitles
                                ? topLeagueInfo.uniqueTournament
                                    .titleHolderTitles
                                : " --"
                            }}
                          </span>
                        ...
                        <li>
                          ...
                          <template
                            v-if="
                              topLeagueInfo.uniqueTournament.mostTitlesTeams
                            "
                          >
                            <span
                              style="color: brown"
                              v-for="mostTitle in topLeagueInfo.uniqueTournament
                                .mostTitlesTeams"
                              :key="mostTitle.name"
                            >
                              {{
                                mostTitle.name + "(" + mostTitle.shortName + ")"
                              }}
                              ,
                            </span>
                          </template>
                      ...
                      <h2 class="comon-heading mt-3 mb-3">About League</h2>
                          ...
                          <div class="dataTables_scrollHead">
                            <div class="dataTables_scrollHeadInner">
                              ...
                              <div class="dataTables_length" id="seri3_length">
                                <label
                                  ...
                                  <select
                                    ...
                                    class=""
                                    id="finished-matches"
                                    v-on:change="getSeasonsStandingsData()"
                                  >
                                    <option
                                      :selected="selected"
                                      :value="season.id"
                              ...
                              <table
                                ...
                                :class="laodingTable ? 'disabled-table' : ''"
                              >
                                <!-- begin::table header -->
                                <thead>
                                  <tr>
                                ...
                                <!-- end::table header -->
                                <!-- begin::table body -->
                                <template v-if="seasonStandingsDetails">
                                  <tbody
...
export default {
  ...
  methods: {
    ...
    getLeagueNews() {
      axios
        .get(`${this.BASE_SERVER_URI}/api/cricket/sofascore/topLeagues/ipl`)
        .then((response) => {
